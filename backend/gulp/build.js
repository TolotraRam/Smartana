...
gulp.task('htmlProductionChange', ['html'], function () {
    return gulp.src([conf.paths.dist + '/index.html'], {base: './'})
        .pipe($.replace('<base href="/">', '<base href="/backend/"><meta name="csrf-token" content="<?php echo csrf_token(); ?>">'))
        .pipe(gulp.dest('./'));
});
